...
หลายหน้าเว็บ (คนละ URL) ใช้ <title> เดียวกัน · ระบบตัดกรณีที่ซ้ำได้ตามปกติออกก่อน (หน้าเด้งไปที่เดียวกัน / ชี้ canonical / คนละภาษา / หน้าเพจย่อย) แล้วจึงนับ

**WHY — ทำไมต้องตรวจ**

เมื่อหลายหน้าใช้ <title> เดียวกัน Search Engine แยกได้ยากว่าหน้าไหนควรแสดงสำหรับคำค้นหนึ่งๆ จึงอาจเลือกหน้าที่ไม่ตรง หรือเขียนชื่อที่แสดงบนผลค้นหาให้ใหม่เอง ทำให้ไม่ตรงกับที่ตั้งใจ
...
หากหลาย URL แสดงเนื้อหาเดียวกันแต่ไม่ประกาศ <link rel=canonical> Search Engine อาจถือเป็นหลายหน้าแยกกัน ทำให้สัญญาณของหน้าถูกแบ่งและอาจเลือก URL ที่ไม่ต้องการมาแสดง · canonical บอกว่า URL ใดคือฉบับหลัก
...
หากทั้ง www และไม่มี www (หรือ http/https) เข้าถึงได้และให้เนื้อหาเดียวกัน Search Engine อาจมองเป็นคนละเว็บที่มีเนื้อหาซ้ำ ทำให้สัญญาณของหน้าถูกแบ่ง · ควรรวมให้เหลือรูปแบบเดียวด้วย redirect + canonical
...
ลิงก์ภายในช่วยให้ผู้ใช้ไปหน้าอื่นต่อ และช่วยให้ Search Engine ค้นพบหน้าและเข้าใจว่าหน้าใดสำคัญ · ลิงก์ภายในน้อยเกินไปทำให้บางหน้าถูกค้นพบยากและดูสำคัญน้อยลง
...
ข้อความลิงก์ (anchor text) บอก Search Engine และผู้ใช้ว่าหน้าปลายทางเกี่ยวกับอะไร · คำกว้างๆ เช่น "คลิกที่นี่/อ่านต่อ" ไม่ให้บริบทนั้น ทำให้เข้าใจความเกี่ยวข้องของหน้าปลายทางได้น้อยลง
...
หน้าที่หนักมากทำให้โหลดช้า โดยเฉพาะบนเครือข่ายช้า ส่งผลต่อ Core Web Vitals (เช่น LCP ที่ช้าลง) ซึ่งเป็นปัจจัยหนึ่งที่ Google ใช้ประกอบการจัดอันดับ
...
E-E-A-T (ประสบการณ์/ความเชี่ยวชาญ/ความน่าเชื่อถือ) เป็นแนวทางประเมินคุณภาพเนื้อหา · การมีข้อมูลผู้เขียน วันที่ และแหล่งอ้างอิงที่ตรวจสอบได้ ช่วยให้ทั้ง Search Engine และ AI ประเมินความน่าเชื่อถือของหน้าได้ดีขึ้น · การขาดสัญญาณเหล่านี้ทำให้ประเมินได้ยาก
